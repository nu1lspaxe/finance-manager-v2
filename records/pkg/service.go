...
func (r *RecordService) CreateRecord(userId int64, amount float32, transactionDate int64, recordType string, detail string) (*sqlc.Record, error) {
...
func (r *RecordService) GetRecord(id int64) (*sqlc.Record, error) {
...
func (r *RecordService) GetUserRecordsWithFilters(userId int64, recordType string, startTime int64, endTime int64) (*[]sqlc.Record, error) {

	var records []sqlc.Record
	var err error
