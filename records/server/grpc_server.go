...
func serviceRoles() map[string][]string {
	const servicePath = "/records.RecordService/"

	return map[string][]string{
		servicePath + "CreateRecord":              {"admin", "user"},
		servicePath + "GetRecord":                 {"admin", "user"},
		servicePath + "GetUserRecordsWithFilters": {"admin", "user"},
		servicePath + "UpdateRecord":              {"admin", "user"},
		servicePath + "DeleteRecord":              {"admin", "user"},
	}
}
